...
class TestPoseDataset(unittest.TestCase):
    ...
    def setUp(self):
        ## pose dataset
        self.__dataset = PoseDataset("test/train_data_for_test", np.load("data/mean.npy"))
        ## cropping size
    ...
    def testDatasetLength(self):
        self.assertEqual(len(self.__dataset), 2)
    ...
    def testGetExample(self):
        ...
        for i in range(N):
            ...
            for j in range(10):
                image, x_2d, x_3d = self.__dataset.get_example(i)
                ...
                image_.save(os.path.join(self.__output_dirname, "{0}_{1}.png".format(i, j)))
