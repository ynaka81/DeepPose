...
class MotionCaptureData(object):
    # define const values
    MARKERS = ("RASI", "LASI", "LPSI", "RELB", "STRN", "LTHI", "LWRA", "LELB", "T10", "RWRA", "RUPA", "RKNE", "RBAK", "LKNE", "CLAV", "RSHO", "LSHO", "C7", "RTIB", "LTIB", "LBHD", "RBHD", "RFHD", "LFHD", "LANK", "LHEE", "RANK", "LTOE", "RTOE", "RHEE", "LFIN", ("RFRM", "RFRA"), ("LFRM", "LFRA"), "RWRB", "RFIN", "LWRB", "RTHI", "LUPA", "RPSI")
    ## constructor
    ...
    def __init__(self, mat_file):
        ...
        sub_group_id = [x[0, 0] for x in param_group[0][group_id]["Parameter"]["name"][0]].index("LABELS")
        self.__data = param_group[0][group_id]["Parameter"][0][sub_group_id]["data"][0]
        ## mocap parameter
